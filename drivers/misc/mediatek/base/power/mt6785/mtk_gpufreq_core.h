...
#define SEG_GPU_DVFS_FREQ1		(934000)	/* KHz */
#define SEG_GPU_DVFS_FREQ2		(918000)	/* KHz */
#define SEG_GPU_DVFS_FREQ3		(901000)	/* KHz */
#define SEG_GPU_DVFS_FREQ4		(885000)	/* KHz */
#define SEG_GPU_DVFS_FREQ5		(869000)	/* KHz */
#define SEG_GPU_DVFS_FREQ6		(853000)	/* KHz */
#define SEG_GPU_DVFS_FREQ7		(837000)	/* KHz */
#define SEG_GPU_DVFS_FREQ8		(820000)	/* KHz */
#define SEG_GPU_DVFS_FREQ9		(804000)	/* KHz */
#define SEG_GPU_DVFS_FREQ10		(788000)	/* KHz */
#define SEG_GPU_DVFS_FREQ11		(772000)	/* KHz */
#define SEG_GPU_DVFS_FREQ12		(756000)	/* KHz */
#define SEG_GPU_DVFS_FREQ13		(740000)	/* KHz */
#define SEG_GPU_DVFS_FREQ14		(723000)	/* KHz */
#define SEG_GPU_DVFS_FREQ15		(707000)	/* KHz */
#define SEG_GPU_DVFS_FREQ16		(691000)	/* KHz */
#define SEG_GPU_DVFS_FREQ17		(675000)	/* KHz */
#define SEG_GPU_DVFS_FREQ18		(659000)	/* KHz */
#define SEG_GPU_DVFS_FREQ19		(642000)	/* KHz */
#define SEG_GPU_DVFS_FREQ20		(626000)	/* KHz */
#define SEG_GPU_DVFS_FREQ21		(610000)	/* KHz */
#define SEG_GPU_DVFS_FREQ22		(594000)	/* KHz */
#define SEG_GPU_DVFS_FREQ23		(578000)	/* KHz */
#define SEG_GPU_DVFS_FREQ24		(561000)	/* KHz */
#define SEG_GPU_DVFS_FREQ25		(545000)	/* KHz */
#define SEG_GPU_DVFS_FREQ26		(529000)	/* KHz */
#define SEG_GPU_DVFS_FREQ27		(513000)	/* KHz */
#define SEG_GPU_DVFS_FREQ28		(497000)	/* KHz */
#define SEG_GPU_DVFS_FREQ29		(480000)	/* KHz */
#define SEG_GPU_DVFS_FREQ30		(464000)	/* KHz */
#define SEG_GPU_DVFS_FREQ31		(448000)	/* KHz */
#define SEG_GPU_DVFS_FREQ32		(432000)	/* KHz */
#define SEG_GPU_DVFS_FREQ33		(416000)	/* KHz */
#define SEG_GPU_DVFS_FREQ34		(400000)	/* KHz */
#define SEG_GPU_DVFS_FREQ35		(383000)	/* KHz */
#define SEG_GPU_DVFS_FREQ36		(367000)	/* KHz */
#define SEG_GPU_DVFS_FREQ37		(351000)	/* KHz */
#define SEG_GPU_DVFS_FREQ38		(335000)	/* KHz */
#define SEG_GPU_DVFS_FREQ39		(319000)	/* KHz */
#define SEG_GPU_DVFS_FREQ40		(302000)	/* KHz */
#define SEG_GPU_DVFS_FREQ41		(286000)	/* KHz */
#define SEG_GPU_DVFS_FREQ42		(270000)	/* KHz */

#define SEG_GPU_DVFS_VOLT0		(88750)		/* mV x 100 */
...
#define SEG_GPU_DVFS_VSRAM0		(98750)		/* mV x 100 */
